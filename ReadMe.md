...
This project was created using React Native for the front-end components, which uses a set of JavaScript libraries. Meanwhile, the React Native code connects to a PHP back-end where the SQL database is then accessed.
