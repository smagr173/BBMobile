...
export default class CartScreen extends Component {
	constructor(props) {
		...
		fetch('https://smagr173.heliohost.us/public/fetchCart.php', {
			method:'POST',
			header:{
	...
	removeItem = (itemID) => {
		fetch('https://smagr173.heliohost.us/public/editCart.php', {
			method:'POST',
			header:{
			  'Accept': 'application/json',
			  'Content-type': 'application/json'
					...
					<View style={{ flexDirection: 'row', marginBottom: 15}}>
					  <View style={{ alignItems: 'flex-start'}}>
				    	<TouchableOpacity
         					...
         					style={{width: Dimensions.get('window').width*.4,height:Dimensions.get('window').height*.057,
							...
							<View style={{flexDirection: 'row'}}>
							    <View style={{ marginRight: Dimensions.get('window').width*.015}}>
                                    <Ionicons
			    	                   name={"ios-add"}
						...
						<View style={{marginTop: 5}}>
							...
							<View style={{ alignItems: 'flex-start', marginTop: -(Dimensions.get('window').height*.03)}}>
								...
								<View style={{flexDirection: 'row', marginTop: Dimensions.get('window').height*.01}}>
									<View style={{marginLeft: Dimensions.get('window').width*.09}}>
										<TouchableOpacity
        									onPress={() => {this.removeItem(item.item_id)}}>
											<View style={{flexDirection: 'row'}}>
												<View style={{ marginTop: Dimensions.get('window').height*-.01, marginRight: Dimensions.get('window').width*.02}}>
                                                  <Ionicons
			    	                                name={"ios-close"}
									...
									<View style={{marginLeft: Dimensions.get('window').width*.09}}>
										<TouchableOpacity
        									onPress={() => {this.favItem(item.name,item.price,item.option1,item.option2,item.extra1,item.extra2,item.extra3)}}>
         									<View style={{flexDirection: 'row'}}>
												<View style={{ marginTop: Dimensions.get('window').height*.0015,marginRight: Dimensions.get('window').width*.02}}>
                                                  <Ionicons
			    	                                name={"ios-heart"}
				                                    size={Dimensions.get('window').height*.027}
				                                    color={'brown'}
				                                  />
                                                </View>
