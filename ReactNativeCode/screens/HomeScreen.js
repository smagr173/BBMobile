...
export default class homeScreen extends Component{
		 ...
		 static navigationOptions= ({navigation}) =>({ 
		  ...
		  <TouchableOpacity
			...
			style={{margin:10,width: Dimensions.get('window').width*.2,height:Dimensions.get('window').height*.045, backgroundColor:'black'}}>
			<Text style={{textAlign:'center',color:'white',fontSize:Dimensions.get('window').height*.017,paddingTop:8}}>Settings</Text>
			</TouchableOpacity>
	});  
